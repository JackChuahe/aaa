...
public abstract class ForwardingBase implements IOFMessageListener {
	...
	public boolean pushRoute(Route route, Match match, OFPacketIn pi,
		...
		boolean sendFlowRemovedMsgFirstSwitch = false;
		...
		for (int indx = switchPortList.size() - 1; indx > 0; indx -= 2) {
			...
			if (!sendFlowRemovedMsgFirstSwitch && (FLOWMOD_DEFAULT_SET_SEND_FLOW_REM_FLAG || requestFlowRemovedNotification)) {
				sendFlowRemovedMsgFirstSwitch = true;
